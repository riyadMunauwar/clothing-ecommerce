        ...
        <div>
            @foreach($addresses as $address)
                <div class="custom-control custom-radio mb-3">
                    <input  wire:model.debounce="address_id" value="{{ $address->id }}" type="radio" id="address-{{ $address->id }}" name="address_id" class="custom-control-input">
            ...
            @endforeach
            <div class="custom-control custom-radio mb-3">
                <input value="" wire:model.debounce="address_id" type="radio" id="address-new" name="address_id" class="custom-control-input">
