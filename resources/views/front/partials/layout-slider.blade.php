                    ...
                    <div class="row row-sm">
                        <div class="col-md-6 col-lg-12">
                            <div class="banner banner-display">
                                <a href="#">
                                    <img src="{{ asset('assets/front/images/banners/home/intro/banner-1.jpg') }}" alt="Banner">
                                </a>
                        ...
                        <div class="col-md-6 col-lg-12">
                            <div class="banner banner-display mb-0">
                                <a href="#">
                                    <img src="{{ asset('assets/front/images/banners/home/intro/banner-2.jpg') }}" alt="Banner">
                                </a>
