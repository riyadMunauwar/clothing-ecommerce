<section class="bg-white mx-auto max-w-screen-xl rounded-md p-5">
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            <td class="px-4 py-3">
                                <img class="w-10 h-10 rounded-full object-cover" src="{{ $menu->iconUrl('thumb') }}" alt="{{ $Menu->name ?? '' }}">
                            </td>
    ...
    <x-ui.loading-spinner wire:loading.flex wire:target="enableMenuEditMode, confirmDeleteMenu" />
</section>
