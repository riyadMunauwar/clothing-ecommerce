<div>
    ...
    <div class="fixed inset-0 overflow-y-scroll pb-20" style="background-color: rgba(0, 0, 0, .50)">
        <div class="bg-white max-w-xl mx-auto rounded-md mt-10">
            ...
            <div class="p-5 flex justify-between border-b">
                <h1>Add Menu Item</h1>
                <span wire:click.debounce="cancelAddNewMenuItemModal" class="cursor-pointer">
    ...
    <x-ui.loading-spinner wire:loading.flex wire:target="createMenu, icon, removeIcon, cancelAddNewMenuItemModal" />
